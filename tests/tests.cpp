...
int deinteg_01() {
	Matrix Y0_apr(6, 1);
	Y0_apr(1, 1) = 7.101597842502546e+06;
	Y0_apr(2, 1) = 1.295247061008991e+06;
	Y0_apr(3, 1) = 1.276289363346384e+04;
	Y0_apr(4, 1) = 5.760976273767675e+02;
	Y0_apr(5, 1) = -3.084510470323088e+03;
	Y0_apr(6, 1) = -6.736011858478301e+03;
	Matrix result = DEInteg(Accel, 0.0, -535.999989509583, 1e-13, 1e-6, 6, Y0_apr);

	Matrix expected(6, 1);
	expected(1, 1) = 5.753212044192128e+06;
	expected(2, 1) = 2.673401894270785e+06;
	expected(3, 1) = 3.440289366522387e+06;
